...
export default function LoginPage() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
      <h1 className='text-4xl mb-2 p-3 bg-gradient-to-r from-blue-500 via-blue-300 to-blue-100 bg-clip-text text-transparent'>{loading ? "Processing" : "Login"}</h1>
      <hr />
      ...
      <button
        ...
        >
        {buttonDisabled ? "Please enter all credentials" : "Login"}
      </button>
      <Link 
